    ...
    <table>
        ...
        <g:each in="${noticeList}" status="i" var="noticeInst">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link controller="admin" action="download" params="[fileName:noticeInst.fileName]" target="_blank"> <img style="width:30px; " src="${resource(dir: 'images', file: 'download.png')}" class="window"></g:link></td>
