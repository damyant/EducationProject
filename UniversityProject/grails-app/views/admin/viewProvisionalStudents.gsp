...
<table class="inner university-table-1-2" style="margin: auto;">
    <tr>
        ...
        <td>
            <g:select name="programId" id="programs" class="university-size-1-2" from="${programList}" optionKey="id" optionValue="courseName" noSelection="['null':' Select Program']" onchange="getStudents()" />
        </td>
    </tr>
</table>
