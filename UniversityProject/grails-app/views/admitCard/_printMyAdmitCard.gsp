...
<g:each in="${studentInstance}" var="student" status="index">
    ...
    <div id="viewAdmit">
        <div>
            ...
            %{--</div>--}%
            <div style="width: 100%;text-transform: capitalize;font-size: 13px;line-height: 20px;">
                    ...
                    <tr>
                        <td style="width: 80%;">
                            <div style="width: 100%;display: inline;">
                                ...
                                <strong>
                                    <div style="width: 60%;float: right;" id="studentName">${student?.firstName} ${student?.middleName} ${student?.lastName}</div>
                                </strong>
                            </div>
                        </td>
                        <td rowspan="4" style="width: 20%;">
                            <div id="profile-image" style="float: right;">
                                <g:if test="${student?.studentImage}">
                                    <rendering:inlineJpeg bytes="${student?.getStudentImage()}" class="university-registration-photo" style="margin:auto; width: 90px;"/>
                                </g:if>
                                <g:else>
