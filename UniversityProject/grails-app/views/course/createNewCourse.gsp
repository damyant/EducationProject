    ...
    <g:form  method="post" name="createCourse" id="createCourse">
        ...
        <table class="university-table">
            <tr>
                ...
                <td><input type="text" id="courseName" value="" name="courseName" maxlength="" class="university-size-1-2" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input id="clear"  type="reset" value="<g:message code="default.button.clear"/>" class="university-button" ></td>
            </tr>
        </table>
    </g:form>
</div>
